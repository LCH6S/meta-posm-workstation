...
本仓库用于托管 Meta POS 相关静态原型，供业务方通过 GitHub Pages 直接查看。
...
- 门店 POS 管理二级菜单：POS 设备列表、POS 功能设置
- 品牌级 POS 设备列表
- 添加设备并通过 suggest 选择门店
- 激活、接单范围设置、设备详情、反激活确认
- 设备状态筛选、设备类型筛选、接单范围筛选
- 未激活设备详情字段展示
- 门店 POS 功能设置列表与独立详情页
- 全局 POS 功能设置中的品牌通用小票打印设置
...
- 外设模式详情页展示 KA Device SN 和条码，便于运维人员绑定设备
